                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body card-block">
                            <form action="{{ route('pengguna-admin.update' ,$data->id) }}" class="p-4" method="POST" name="editData" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                                <div class="row form-group">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <input type="text" name="name" value="{{ old('name',$data->name) }}" id="name" class="input-lg form-control-lg form-control @error('name') is-invalid @enderror"  aria-describedby="helpId" autofocus>
                                    ...
                                    <div class="col-lg-8 mt-4">
                                        ...
                                        <input type="text" name="username" value="{{ old('username', $data->username) }}" id="username" class="input-lg form-control-lg form-control @error('username') is-invalid @enderror"  aria-describedby="helpId" autofocus>
                                    ...
                                    <div class="col-lg-12 mt-4">
                                        ...
                                        <div class="form-check-inline form-check d-flex align-items-end">
                                            <div class="mr-3 customRadio d-flex">
                                                <input class="form-check-input" name="gender" type="radio" value="l" {{ old('gender',  $data->gender == 'L' ? 'checked' : '')}} id="l">
                                                <label class="form-check-label align-self-center" style="font-size: 14px" for="l">Laki-Laki</label>
                                            </div>
                                            <input class="form-check-input" name="gender" type="radio" value="p" {{ old('gender',  $data->gender == 'P' ? 'checked' : '')}} id="p">
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div class="photos-preview h-100 rounded" style="background-color: #e5e5e5">
                                            <div class=" ">
                                                <img src="{{ asset('uploads/profile/'.$data->photos) }}" class="img-fluid rounded d-flex align-items-center " id="photosPreview" alt="Foto Pengguna">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
