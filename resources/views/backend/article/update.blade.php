            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body card-block">
                        <form action=" {{ route('article.update', $data->id) }} " class="p-4" method="POST" name="tambaData" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            <div class="row form-group">
                                <div class="col-lg-8 mb-4">
                                    <div class="row">
                                        <div class="col">
                                            <img src=" {{ asset('uploads/article/cover/'. $data->cover) }}" class="img-fluid rounded" alt="" srcset="">
                                        </div>
                                        <div class="col">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="text" name="title" id="title" value=" {{ $data->title }} " class="input-lg form-control-lg form-control @error('name') is-invalid @enderror"  aria-describedby="helpId" autofocus>
                                ...
                                <div class="col-lg-8 mt-4">
                                    ...
                                    <textarea id="summernote" name="deskripsi" class="form-control @error('name') is-invalid @enderror"> {!! $data ->desc !!} </textarea>
                                </div>
                            </div>
                    </div>
