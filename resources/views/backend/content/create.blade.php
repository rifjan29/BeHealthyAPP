            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body card-block">
                        <form action="{{ route('content.store') }}" class="p-4" method="POST" name="tambaData" enctype="multipart/form-data">
                        @csrf
                            <div class="row form-group">
                                ...
                                <div class="col-lg-8 mb-4">
                                    ...
                                    <select name="category" data-style="btn-info" id="category" class="form-control-lg form-control selectpicker" data-live-search="true" style="font-size: 16px">
                                        ...
                                        <option value="{{ $items->id }} - {{ $items->id_type }}">{{ $items->name_category }} -  <h1 style="font-weight: bold">{{ $items->type }}</h1></option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-8 mb-4">
                                    ...
                                    <select name="narator" data-style="btn-info" id="narator" class="form-control-lg form-control selectpicker" data-live-search="true" style="font-size: 16px">
                                        <option value="0">Pilih Narator</option>
                                        @foreach ($authors as $items)
                                        <option value="{{ $items->id }}">{{ $items->name_author }}</h1></option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="text" name="youtube" id="youtube"  class="input-lg form-control-lg form-control @error('youtube') is-invalid @enderror" aria-describedby="helpId">
                                ...
                                <div class="col-lg-8 mt-4">
                                    ...
                                    <textarea name="deskripsi" class="input-lg form-control-lg form-control @error('name') is-invalid @enderror" id="deskripsi" cols="4" rows="4" style="font-size: 16px"></textarea>
